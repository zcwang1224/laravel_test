          ...
          <div class="">          
            <div class="page-title">
              <div class="title_left">
                <h3>{{ trans('member.memberIndex_title') }}</h3>
              </div>
            </div>            
            <form method="POST" action="{{ route('admin_member_index_edit') }}" id="main_form" data-parsley-validate class="form-horizontal form-label-left">
              {{ csrf_field() }}            
          ...
          {{-- ------------------ SEO 設定------------------ --}}             
              <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                  <div class="x_panel">
                    <div class="x_title">
                      <h2>{{ trans('member.memberIndexSeo_title') }} 
                  ...
                  {{-- SEO Title 標題 --}}
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">{{ trans('member.memberIndexSeo_seo_title') }}
                         <!-- <span class="required">*</span> -->
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="seo_title" value="{{ $member->seo_title or '' }}" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                  {{-- SEO Description 敘述 --}}    
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">{{ trans('member.memberIndexSeo_seo_description') }}
                        <!-- <span class="required">*</span> -->
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="seo_description" value="{{ $member->seo_description or ''  }}" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                  {{-- SEO Keyword 關鍵字 --}}
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">{{ trans('member.memberIndexSeo_seo_keyword') }}
                        <!-- <span class="required">*</span> -->
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="seo_keyword" value="{{ $member->seo_keyword or ''  }}" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>  
                    </div>
                  </div>
              ...
              <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                  <div class="x_panel">
                    <div class="x_title">
                      <h2>{{ trans('member.memberIndexContent_title') }} 
                          {{-- <small>different form elements</small> --}}
                      </h2>
                      <ul class="nav navbar-right panel_toolbox">
                        <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                    ...
                    {{-- CKEditor with Responsive FileSystem --}}
                      <textarea id="content" name="content" class="form-control">{{ $member->content or '' }}</textarea>
