    ...
    @parent
        <div class="right_col" role="main" id="main">
          <div class="">
            ...
            <form method="POST" action="{{ route('admin_member_item_edit',['id' => $user->id]) }}" id="main_form" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
              {{ csrf_field() }}            
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                      ...
                      <div class="form-group">
                          ...
                          <div style="padding: 5px;position: relative;margin-left: 25%;margin-right: 25%">  
                                ...
                                @foreach($roles as $role_key => $role)
                                  <li>
                                    <label>
                                      <input type="checkbox" name="role[]" value="{{ $role->name }}" @if($user->hasRole($role->name)) checked @endif required class="flat " /> {{ $role->display_name }}
                                    </label>
                                  </li>
                                @endforeach
                                </ul>
                  ...
                  {{-- mobile 手機 --}}                      
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="mobile" value="{{ $user->mobile }}" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <br />                                            
                  {{-- Image Upload 圖片上傳 --}} 
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name"> {{ trans('member.memberItem_item_category') }}
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                           <div class="input-group">
                             ...
                             <input id="thumbnail" class="form-control" type="text" name="image" value="{{ $user->image }}" readonly>
                           </div>
                           <img id="holder" style="margin-top:15px;max-height:100px;" src="{{ $user->image }}">
                        </div>
                      </div>  
                      <br /> 
                  {{-- Status 分類狀態 --}}                                              
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <label>
                            <input type="checkbox" name="status" class="js-switch" value="1" @if($user->status ==1) checked @endif/> {{ trans('default.default_checked') }}
                          </label>
                        </div> 
                      </div>  
                    </div>               
