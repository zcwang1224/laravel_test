            ...
            <div class="page-title">
              <div class="title_left">
                <h3>{{ trans_choice('member.member_title',2,['type1' => trans('default.default_category'),
                                                             'type2' => trans('default.default_edit')]) }}</h3>
              </div>
            </div>
            <form method="POST" action="{{ route('admin_member_category_edit',['id' => $role->id]) }}" id="main_form" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
              {{ csrf_field() }}            
                  ...
                  {{-- Name 標題 --}}
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="name" value="{{ $role->display_name }}" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <br /> 
                    </div>               
