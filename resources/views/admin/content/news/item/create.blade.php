          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>{{ trans('news.newsItemCreate_item_title',['type' => trans('default.default_create')]) }}</h3>
              </div>
            </div>
            <form method="POST" action="{{ route('admin_news_item_create') }}" id="main_form" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
              {{ csrf_field() }}            
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          @foreach($newsCategories as $key => $newsCategory)
                            <option value="{{ $newsCategory->news_category_id }}">{{ $newsCategory->name }}</option>
                          @endforeach               
                          </select>
                        </div>
                      </div>                     
