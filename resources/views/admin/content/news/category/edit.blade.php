          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>{{ trans('news.newsCategoryCreate_title',['type' => trans('default.default_edit')]) }}</h3>
              </div>
            </div>
            <form method="POST" action="{{ route('admin_news_category_edit',['id' => $newsCategory->news_category_id]) }}" id="main_form" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
              {{ csrf_field() }}            
          ...
          {{-- ------------------ 基本 設定------------------ --}}             
                  ...
                  {{-- Name 標題 --}}
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="name" value="{{ $newsCategory->name }}" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div> 
                      <br /> 
                 {{-- Image Upload 圖片上傳 --}} 
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                           <div class="input-group">
                             ...
                             <input id="thumbnail" class="form-control" type="text" name="image" value="{{ $newsCategory->image }}" readonly>
                           </div>
                           <img id="holder" style="margin-top:15px;max-height:100px;" src="{{ $newsCategory->image }}">
                        </div>
                      </div>     
                  {{-- Status 分類狀態 --}}                                          
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <label>
                            <input type="checkbox" name="status" class="js-switch" value="1" @if($newsCategory->status ==1) checked @endif/> {{ trans('default.default_checked') }}
                          </label>
                        </div> 
                      </div>  
                    </div>               
              ...
              <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                  <div class="x_panel">
                    <div class="x_title">
                      <h2>{{ trans('news.newsCategoryCreate_content_title')}}
                      {{-- <small>different form elements</small> --}}
                      </h2>
                      <ul class="nav navbar-right panel_toolbox">
                        <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
              ...
              <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                  <div class="x_panel">
                    <div class="x_title">
                      <h2>{{ trans('news.newsCategoryCreate_seo_seo_title') }} 
                      {{-- <small>different form elements</small> --}}
                      </h2>
                      <ul class="nav navbar-right panel_toolbox">
                        <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                    ...
                    <div class="x_content">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="seo_title" value="{{ $newsCategory->seo_title }}" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="seo_description" value="{{ $newsCategory->seo_description }}" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="seo_keyword" value="{{ $newsCategory->seo_keyword }}" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>  
                    </div>
                  </div>
