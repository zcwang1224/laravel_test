          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>{{ trans('news.newsCategoryCreate_title',['type' => trans('default.default_create')]) }}</h3>
              </div>
            </div>
            <form method="POST" action="{{ route('admin_news_category_create') }}" id="main_form" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
              {{ csrf_field() }}            
